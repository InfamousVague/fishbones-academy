    ...
    <div className="languages-page">
      <header className="languages-page__head section section--narrow">
        ...
        <p className="section__subtitle">
          Here's every language Libre Academy supports, each with its real
          runtime and a free course library. The free desktop app runs them
          all. Scripting languages execute instantly, and compiled ones run
          via hosted sandboxes or your local toolchain.
        </p>
      </header>
      ...
      <section className="section">
        <Group
          ...
          blurb="No toolchain to set up. These languages execute the moment you hit Run, whether that's in a Web Worker, an iframe, or Pyodide, and the hidden tests grade your code right in place."
          languages={browser}
          counts={courseCounts}
        />
        <Group
